...
<section>
    <div class="container">
        <div class="row justify-content-center bg-success text-light">
            <div class="col-md-5">
                <h1 class="text-center mb-4 mt-2">Add Cart</h1>
...
<!--                        <label for="inputId" class="col-sm-2 col-form-label">Id</label>-->
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="inputSold" name="sold" value="">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputPrductID" class="col-sm-2 col-form-label">Product ID</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="inputProductID" name="product_id" value="">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputProductTitle" class="col-sm-2 col-form-label">Product Title</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputProductTitle" name="product_title" value="">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputQuantity" class="col-sm-2 col-form-label">Quantity</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="inputQuantity" name="qty" value="">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputPrductID" class="col-sm-2 col-form-label">Unit Price</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="inputProductID" name="unit_price" value="">
                        </div>
                    </div>
<!--                    <div class="mb-3 row">-->
