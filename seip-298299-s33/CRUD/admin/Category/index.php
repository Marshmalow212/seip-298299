...
use Crud\CategoryController;

$_carts = new CategoryController();
    ...
    <div class="container">
        <div class="row justify-content-center ">
            <div class="col-md-6">
                ...
                <ul>
                    <li class="inline-list-item nav-link">        <a href="create.php" class="btn btn-outline-dark">Create Category</a></li>
                </ul>
